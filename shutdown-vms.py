...
def shutdown_vm(hostname, port, username, key_filepath, connection_timeout=5, command_timeout=5):
    try:
        ...
        stdin, stdout, stderr = ssh.exec_command(
            'sudo shutdown -h now', timeout=command_timeout)
...
# List of VM details
vms = [
    {'hostname': '192.168.1.246', 'port': 22,
        'username': 'root', 'key_filepath': '/Users/andrew/.ssh/id_ed25519'},
    {'hostname': '192.168.1.247', 'port': 22,
        'username': 'andrew', 'key_filepath': '/Users/andrew/.ssh/id_ed25519'},
    {'hostname': '192.168.1.249', 'port': 22,
        'username': 'andrew', 'key_filepath': '/Users/andrew/.ssh/id_ed25519'},
    {'hostname': '192.168.1.250', 'port': 22,
        'username': 'andrew', 'key_filepath': '/Users/andrew/.ssh/id_ed25519'},
    {'hostname': '192.168.1.251', 'port': 22,
        'username': 'andrew', 'key_filepath': '/Users/andrew/.ssh/id_ed25519'},
    {'hostname': '192.168.66.254', 'port': 22,
